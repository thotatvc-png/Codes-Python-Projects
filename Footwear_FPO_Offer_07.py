...
from
fdp_uploads.ds_fkint_2gud_partner_gsm_re_lids_pids_1_0 a
left join
...
(
  ...
  (
    ...
    and data.offerid in ('nb:mp:06ce495d05')
    GROUP BY
    data.listingid,
    data.offerid
  )a 
...
if df_optin.empty:
    ...
    # Read Input File
    import pandas as pd
    file_path_1 = '/home/thotat.vc/analytics_scripts/fpo_footwear_07_offer.csv'
    ...
    df_orders=pd.read_csv('/home/thotat.vc/analytics_scripts/new_fpo_offer_orders_file.csv')
    ...
    <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">opted_in_orders</th>
...
<table class="left-aligned-table" style="width:100%; border-collapse: collapse; border: 1px solid #ddd;">
    <thead>
        <tr>
            ...
            <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">listing_id</th>
            <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">opted_in_listing_id_overall</th>
            <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">seller_id</th>
            <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">opted_in_seller_id</th>
            <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">orders_drr</th>
            <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">opted_in_orders_drr</th>
            <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">Opt In LID %</th>
            <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">Opt In SID %</th>
            <th style="border: 1px solid #ddd; padding: 8px; background-color: darkblue; color: white;">DW %</th>
        </tr>
...
'''
    ...
    with pd.ExcelWriter(f"/home/thotat.vc/Downloads/Footwear_FPO_Offer_07{today}.xlsx") as writer:
    ...
    filename = f"Re:Footwear_FPO_Offer_07{today}.xlsx"
    file_path = f"/home/thotat.vc/Downloads/Footwear_FPO_Offer_07{today}.xlsx"   
...
if __name__ == "__main__":
    ...
    file_path = '/home/thotat.vc/Downloads/Footwear_FPO_Offer_07{date}.xlsx'.format(date=today)
  # Replace with actual file path
    ...
    original_message_id = '<CALaUBBjiq9RtrT9SuYpdMjkxjsdRarGvaOc8NVGs1a-fKyipEA@mail.gmail.com>'
    ...
    msg['Subject'] = f"Re: Footwear - FPO Offer Required"
    msg['In-Reply-To'] = original_message_id
    msg['References'] = original_message_id

    body = f"""
    Hi Team,<br><br>
    Please find the Supercategory summary for the Footwear - FPO Offer Required.:<br><br>
    {html_table_supercat}<br><br>
    Please find below the optin status for Footwear - FPO Offer Required.:<br><br>
    {html_table}<br><br>
