...
from
fdp_uploads.ds_fkint_2gud_partner_vishnu_adhoc2_1_0 a
left join
...
(
  ...
  (
    ...
    and data.offerid in ('nb:mp:07d7954619')
    GROUP BY
    data.listingid,
    data.offerid
  )a 
...
if df_optin.empty:
    ...
    # Read Input File
    import pandas as pd
    file_path_1 = '/home/thotat.vc/analytics_scripts/20082025_BPC_optin_basefile.csv'
    ...
    df_orders=pd.read_csv('/home/thotat.vc/analytics_scripts/20082025_BPC_optin_orders.csv')
...
'''
    ...
    with pd.ExcelWriter(f"/home/thotat.vc/Downloads/BPC_optin{today}.xlsx") as writer:
    ...
    filename = f"GSM_AUG_BGM_HELF_{today}.xlsx"
    file_path = f"/home/thotat.vc/Downloads/BPC_optin{today}.xlsx"   
...
if __name__ == "__main__":
  ...
  # Replace with actual file path
    ...
    original_to = ['vishnuac.vc@flipkart.com']
    ...
    original_message_id = '<20250819140737.BA94285BB6@fkp-fdp-xpslv-fvm-prod-d326f8c8-dc7t.c.fkp-fdp-xpslv.internal.flipkart.com>'
    ...
    msg['Subject'] = f"Re: BPC Category Days 19-20 Aug"
    msg['In-Reply-To'] = original_message_id
    msg['References'] = original_message_id

    body = f"""
    Hi Team,<br><br>
    Please find the Supercategory summary for the Additional BPC_optin:<br><br>
    {html_table_supercat}<br><br>
    Please find below the optin status for  Additional BPC_optin.:<br><br>
    {html_table}<br><br>
    The attached drive file contains the raw and summary data for your reference: {link}.<br><br>
    In drive file_name is  Additional BPC_optin date<br><br>
    <b>Regards,<br>
    Vamsi</b>
    """
