...
(
  ...
  (
    ...
    and data.offerid in ('nb:mp:0412dda827','nb:mp:04397bd727','nb:mp:04767cca27','nb:mp:04f2283527','nb:mp:04d0db1a27','nb:mp:04ed8f2127','nb:mp:047950c027','nb:mp:0477e8d027','nb:mp:04438f7b27','nb:mp:04baefb927','nb:mp:04b8abea27')
    GROUP BY
    data.listingid,
    data.offerid
  )a 
...
if df_optin.empty:
    ...
    # df_1_1['KAM'] = df_1_1['KAM'].apply(lambda x: 'HARSHITA PANDEY' if str(x).strip().lower() == 'harshita' else x)
    ...
    with pd.ExcelWriter(f"/home/thotat.vc/Downloads/EOSS_JUNE_NON_APPAREL+ADDITIONAL_INPUTS_OFFER_SHEET{today}.xlsx") as writer:
    ...
    filename = f"M-seller_May_offers_{today}.xlsx"
    file_path = f"/home/thotat.vc/Downloads/EOSS_JUNE_NON_APPAREL+ADDITIONAL_INPUTS_OFFER_SHEET{today}.xlsx"   
    ...
    original_to = ['upasanaupadhak.vc@flipkart.com','vishnuac.vc@flipkart.com','shopsy_buy@flipkart.com', 'shopsy_buy_cr@flipkart.com', 'shopsysell@flipkart.com', 'shopsypricing@flipkart.com']
    ...
    original_message_id = '<CAFTNLLaNoj4-p67sRg2TMVR=H-B1U7Ts0R3De_L31Mcy6rGmWA@mail.gmail.com>'
    ...
    msg['Subject'] = f"Re: EOSS June – Non-Apparel + Additional Inputs Offers"
    msg['In-Reply-To'] = original_message_id
    msg['References'] = original_message_id

    body = f"""
    Hi Team,<br><br>
    Please find below the optin status for EOSS June - Non-Apparel + Additional Inputs Offers:<br><br>
    {html_table}<br><br>
