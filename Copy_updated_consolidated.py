...
if df_optin.empty:
    ...
    original_to = ['upasanaupadhak.vc@flipkart.com','h.kishandasmenon@flipkart.com','vishnuac.vc@flipkart.com','s.abhishek@flipkart.com','abhishek.patwari@flipkart.com']
