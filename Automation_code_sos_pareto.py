...
df.to_csv(f"/home/thotat.vc/Downloads/Pareto_SOS_{today}.csv",index=False)
# df=pd.read_csv(r'/home/thotat.vc/Downloads/Pareto_SOS_+_FOS_01_Mar_2026.csv')
...
file = fr'/home/thotat.vc/Downloads/Pareto_SOS{today}.xlsx'
...
file_path = f"/home/thotat.vc/Downloads/Pareto_SOS{today}.xlsx"
...
dataframes = [owner_summary, bu_summary, owner_summary_60, bu_summary_60]

start_row = 59  # Start pasting at A59
...
creds = ServiceAccountCredentials.from_json_keyfile_name(creds_path, scope)
client = gspread.authorize(creds)
spreadsheet = client.open("Monthly Business Review-Buy")          # Replace with your Google Sheet name
ws = spreadsheet.worksheet("Pareto_raw")   
...
ws.update_acell("A2", now.strftime("%Y%m%d"))
