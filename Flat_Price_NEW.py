...
df_listing.to_csv(f'/home/thotat.vc/analytics_scripts/flat_price_listing_.csv') 
...
FROM (
    ...
    FROM (
        ...
        WHERE day > lookup_date(date_sub(CURRENT_DATE, 60))
          AND data.offerid IN ('nb:mp:00da1dde23',	'nb:mp:00aaa38023',	'nb:mp:000e398923',	'nb:mp:0087f70c23',	'nb:mp:004e4ebf23',	'nb:mp:00f8fe7b23',	'nb:mp:0067315523',	'nb:mp:000fa9d823',	'nb:mp:005cfa2123',	'nb:mp:002e034023',	'nb:mp:00a11d8823',	'nb:mp:00931be023',	'nb:mp:00a51e2523')
...
df_optin.to_csv(f'/home/thotat.vc/analytics_scripts/flat_price_optin.csv')
