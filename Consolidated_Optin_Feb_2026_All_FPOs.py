...
df_listing=pd.read_csv(f'/home/thotat.vc/analytics_scripts/listing_raw_consolidated_1.csv', encoding='cp1252') # Run this when code fails so that you pickup the last query output
print(df_listing)
...
df_optin=pd.read_csv(f'/home/thotat.vc/analytics_scripts/optin_raw_consolidated_1.csv') # Run this when code fails so that you pickup the last query output
print(df_optin)
...
if df_optin.empty:
    ...
    df_1_1['listing_id']=df_1_1['listing_id'].astype(str).str.strip()
    df_final_mapping['LID']=df_final_mapping['LID'].astype(str).str.strip()
...
'''
    ...
    original_to = ['thotat.vc@flipkart.com', 'vishnuac.vc@flipkart.com','shopsypricing@flipkart.com','h.kishandasmenon@flipkart.com','sriram.m@flipkart.com']
