...
(
  ...
  (
    ...
    and data.offerid in ('nb:mp:07a3aac822','nb:mp:0764a4be22')
    GROUP BY
    data.listingid,
    data.offerid
  )a 
...
if df_optin.empty:
    ...
    # Read Input File
    import pandas as pd
    file_path_1 = '/home/thotat.vc/analytics_scripts/22082025_Sep_GSM_Additional_inputs_base_file.csv'
    ...
    df_orders=pd.read_csv('/home/thotat.vc/analytics_scripts/22082025_Sep_GSM_Additional_Inputs_Orders.csv')
...
'''
    ...
    with pd.ExcelWriter(f"/home/thotat.vc/Downloads/september_gsm_additional{today}.xlsx") as writer:
    ...
    filename = f"september_gsm_additional{today}.xlsx"
    file_path = f"/home/thotat.vc/Downloads/september_gsm_additional{today}.xlsx"   
...
if __name__ == "__main__":
  ...
  # Replace with actual file path
    ...
    original_message_id = '	<CAFTNLLamoaPj1CcDh93VqumUVaQOFGFjq9SWvOAochBm0R3upA@mail.gmail.com>'
    ...
    msg['Subject'] = f"September GSM Offer File for Additional Inputs"
    msg['In-Reply-To'] = original_message_id
    msg['References'] = original_message_id

    body = f"""
    Hi Team,<br><br>
    Please find the Supercategory summary for the September GSM Offer File for Additional Input :<br><br>
    {html_table_supercat}<br><br>
    Please find below the optin status for September GSM Offer File for Additional Input.:<br><br>
    {html_table}<br><br>
    The attached drive file contains the raw and summary data for your reference: {link}.<br><br>
    In drive file_name is  september_gsm_additional_today's date<br><br>
    <b>Regards,<br>
    Vamsi</b>
    """
